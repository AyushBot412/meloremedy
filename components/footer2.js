              ...
              <div className="footer2-container1">
                <div className="footer2-column1">
                  <strong className="thq-body-large">
                    {props.column1Title ?? (
                      <Fragment>
                        <span className="footer2-text27">Meloremedy</span>
                      </Fragment>
                    )}
                  </strong>
                  <div className="footer2-footer-links1">
                    ...
                    >
                      {props.link1 ?? (
                        <Fragment>
                          <span className="footer2-text16">/about</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                    ...
                    >
                      {props.link2 ?? (
                        <Fragment>
                          <span className="footer2-text19">/music-therapy</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                    ...
                    >
                      {props.link5 ?? (
                        <Fragment>
                          <span className="footer2-text17">/testimonials</span>
                        </Fragment>
                      )}
                    </a>
                  </div>
                ...
                <div className="footer2-column2">
                  <strong className="thq-body-large">
                    {props.column2Title ?? (
                      <Fragment>
                        <span className="footer2-text20">Quick Links</span>
                      </Fragment>
                    )}
                  </strong>
                  <div className="footer2-footer-links2">
                    ...
                    >
                      {props.link6 ?? (
                        <Fragment>
                          <span className="footer2-text15">/contact</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                    ...
                    >
                      {props.link7 ?? (
                        <Fragment>
                          <span className="footer2-text22">/blog</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                    ...
                    >
                      {props.link8 ?? (
                        <Fragment>
                          <span className="footer2-text10">/shop</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                    ...
                    >
                      {props.link9 ?? (
                        <Fragment>
                          <span className="footer2-text23">/faq</span>
                        </Fragment>
                      )}
                    </a>
                    <a
                  ...
                  {props.content1 ?? (
                    <Fragment>
                      <span className="footer2-text12">
                        © 2023 Meloremedy. All rights reserved.
                      </span>
                    </Fragment>
                  )}
                </span>
                ...
                <div className="footer2-form">
                  ...
                  <button className="thq-button-outline footer2-button">
                    <span className="thq-body-small">
                      {props.action1 ?? (
                        <Fragment>
                          <span className="footer2-text13">Subscribe</span>
                        </Fragment>
                      )}
                    </span>
                  </button>
                  ...
                  {props.content2 ?? (
                    <Fragment>
                      <span className="footer2-text14">
                        Disclaimer: This website is for informational purposes
              ...
              <div className="footer2-credits2">
                ...
                <div className="footer2-footer-links3">
                  <span className="thq-body-small">
                    {props.privacyLink ?? (
                      <Fragment>
                        <span className="footer2-text26">/privacy</span>
                      </Fragment>
                    )}
                  </span>
                  <span className="thq-body-small">
                    {props.termsLink ?? (
                      <Fragment>
                        <span className="footer2-text11">/terms</span>
                      </Fragment>
                    )}
                  </span>
                  <span className="thq-body-small">
                    {props.cookiesLink ?? (
                      <Fragment>
                        <span className="footer2-text18">/cookies</span>
                      </Fragment>
                    )}
                  </span>
                </div>
